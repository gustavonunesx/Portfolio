    ...
    <section className={styles.section} id="contact">
      ...
      <div className={styles.header}>
        <p className={`${styles.eyebrow} reveal`}>
          <span className={styles.eyebrowSlash}>//</span> Contato
        </p>
        <h2 className={`${styles.title} reveal`}>
          Vamos <span className={styles.accent}>conversar.</span>
        </h2>
        <p className={`${styles.sub} reveal`}>
          Tem um projeto em mente ou quer bater um papo sobre tecnologia?<br />
      ...
      <div className={styles.grid}>
        {channels.map((c, i) => (
          <a
            ...
            style={{ animationDelay: `${i * 0.08}s`, '--ch-color': c.color }}
          >
            <div className={styles.cardIcon} style={{ background: `${c.color}18`, border: `1px solid ${c.color}33` }}>
      ...
      <div className={`${styles.cta} reveal`}>
        ...
        <a href="mailto:gustavo@email.com?subject=Quero um orçamento" className={styles.ctaBtn}>
