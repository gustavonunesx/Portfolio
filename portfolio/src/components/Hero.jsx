  ...
  return (
    <section className={styles.hero} id="hero">
      ...
      <div className={styles.textSide}>
        ...
        <p className={styles.hello}>Olá, eu sou</p>
        <h1 className={styles.name}>
          Gustavo<br />
          <span className={styles.nameAccent}>Nunes</span>
        </h1>

        <p className={styles.desc}>
          Transformo ideias em{' '}
          <span className={styles.highlight}>sites, landing pages</span> e{' '}
          <span className={styles.highlight}>sistemas completos</span>.
          Do layout à API — resultado real, prazo e qualidade.
        </p>

        <div className={styles.social}>
          <a href="https://linkedin.com/in/gustavonunes" target="_blank" rel="noreferrer" aria-label="LinkedIn">
            <LinkedinIcon />
          </a>
          <a href="https://github.com/gustavonunes" target="_blank" rel="noreferrer" aria-label="GitHub">
            <GithubIcon />
          </a>
          <a href="https://instagram.com/gustavonunes" target="_blank" rel="noreferrer" aria-label="Instagram">
            <InstagramIcon />
          </a>
        </div>
